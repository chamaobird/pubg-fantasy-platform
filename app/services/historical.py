...
def _compute_late_game_bonus(all_stats: list) -> dict:
    ...
    # Duração estimada da partida = maior survival_secs entre os vencedores
    ...
    # Sobreviventes do time vencedor: survival >= max - 60s
    ...
    # +10 para sobreviventes
    for s in survivors:
        bonus[s.player_id] = bonus.get(s.player_id, 0) + 10

    # Jogadores que não são sobreviventes, ordenados por survival_secs desc
